...
;
curscr: 	dw scrn89 		; pointer to current screen
...
sbctrlb:	
		    ...
		    ;mkctrlb osabotr,0,sbstay,dirrt,SABSTADR,sabsprt,0,5,3
            mkctrlb osabotr,0,sbstay,dirrt,SABSTADR,sabsprt,0,10,10
