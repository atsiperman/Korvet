...
sabsplt:
		...
		DB 255,0,  252,0,   15,  0,   255, 0
		DB 255,0,  248,1,   7,   224, 255, 0
		DB 255,0,  240,3,   7,   240, 255, 0
		DB 255,0,  240,7,   7,   240, 255, 0
		DB 255,0,  240,7,   7,   240, 255, 0
		DB 255,0,  240,7,   7,   80,  255, 0
		DB 255,0,  0,  7,   7,   32,  255, 0
		DB 254,0,  0,  119, 7,   240, 255, 0
		DB 252,0,  0,  231, 7,   240, 255, 0
		DB 252,1,  0,  223, 1,   240, 255, 0
		DB 252,1,  0,  63,  0,   236, 255, 0
		DB 252,0,  0,  255, 0,   30,  255, 0
		DB 248,1,  0,  255, 0,   254, 127, 0
		DB 240,3,  0,  255, 0,   255, 127, 0
		DB 240,7,  0,  255, 0,   255,  63, 0
		DB 224,7,  0,  223, 0,   239,  31, 128
		DB 224,15, 0,  159, 0,   255,   0, 192
		DB 224,15, 0,  47,  0,   253,   0, 251
		DB 224,14, 0,  111, 0,   253,   0, 255
		DB 224,14, 0,  111, 0,   254,   0, 127
		DB 224,14, 0,  119, 0,   254,   0, 15
		DB 224,14, 0,  119, 0,   254, 224, 0
		DB 224,7,  0,  119, 0,   254, 255, 0
		DB 240,7,  0,  180, 0,   2,   127, 0
		DB 240,3,  0,  196, 0,   255,  63, 0
		DB 248,3,  16, 199, 0,   255,  63, 128
		DB 248,1,  0,  7,   0,   255,  31, 128
		DB 252,0,  96, 15,  0,   255,  31, 192
		DB 255,0,  192,15,  0,   255,  15, 192
		DB 255,0,  192,31,  0,   255,  15, 224
		DB 255,0,  192,31,  0,   207,   7, 224
		DB 255,0,  128,31,  0,   7,     7, 240
		DB 255,0,  128,63,  112, 3,     7, 240
		DB 255,0,  128,62,  120, 3,     7, 240
		DB 255,0,  0,  62,  248, 1,     7, 240
		DB 255,0,  0,  126, 252, 1,     7, 240
		DB 255,0,  0,  124, 252, 1,     7, 240
		DB 255,0,  1,  124, 252, 0,     7, 240
		DB 255,0,  1,  124, 254, 0,     7, 224
		DB 255,0,  1,  124, 254, 0,    15, 160
		DB 255,0,  1,  68,  254, 0,    15, 224
		DB 255,0,  1,  60,  254, 0,    15, 224
		DB 255,0,  1,  60,  254, 0,    15, 224
		DB 255,0,  1,  56,  254, 0,     7, 224
		DB 255,0,  1,  56,  254, 0,     1, 240
		DB 255,0,  1,  124, 254, 0,     0, 252
		DB 255,0,  1,  124, 254, 0,     0, 254
